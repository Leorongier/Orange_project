...
# URL de l'API GitHub pour le fichier .pkl
pkl_url = 'https://api.github.com/repos/Leorongier/Orange_project/contents/CEFR_Classifier_French/svm_clf.pkl?ref=main'

# Fonction pour télécharger un fichier .pkl depuis GitHub
def download_pkl(url):
    response = requests.get(url)
    if response.status_code != 200:
        raise Exception("Failed to download file: ", response.text)
    content = response.json()['content']
    decoded_content = base64.b64decode(content)
    return BytesIO(decoded_content)

# Télécharger et charger le fichier .pkl
pkl_content = download_pkl(pkl_url)
model = joblib.load(pkl_content)

model_url = 'https://raw.githubusercontent.com/Leorongier/Orange_project/main/CEFR_Classifier_French/model.py'
data_url = 'https://raw.githubusercontent.com/Leorongier/Orange_project/main/database/training_data.csv'
image_url = 'https://github.com//Leorongier/Orange_project/main/Application/Logo_team_orange_DS&ML.png'
...
data_content = download_file(data_url)
